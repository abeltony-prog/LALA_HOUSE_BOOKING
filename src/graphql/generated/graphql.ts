...
export const useAddNewUserMutation = <TError = unknown, TContext = unknown>(
  ...
  >(
    ["AddNewUser"],
    (variables?: AddNewUserMutationVariables) =>
      fetcher<AddNewUserMutation, AddNewUserMutationVariables>(
        AddNewUserDocument,
        variables
      )(),
    options
