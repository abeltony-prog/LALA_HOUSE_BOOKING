...
export type AddNewUserMutation = { __typename?: 'mutation_root', insert_users?: { __typename?: 'users_mutation_response', affected_rows: number } | null };
...
export const AddNewUserDocument = `
    mutation AddNewUser($role: String = "", $password: String = "", $name: String = "", $gender: String = "", $email: String = "") {
  insert_users(
...
export const useAddNewUserMutation = <
    ...
    return useMutation<AddNewUserMutation, TError, AddNewUserMutationVariables, TContext>(
      ['AddNewUser'],
