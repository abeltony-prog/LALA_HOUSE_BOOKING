...
export type RemoveBookingsWherebooking_IdMutation = { __typename?: 'mutation_root', delete_bookings?: { __typename?: 'bookings_mutation_response', affected_rows: number } | null };
...
export type GetBookingsWhereUser_IdQuery = { __typename?: 'query_root', bookings: Array<{ __typename?: 'bookings', user_id?: any | null, to_date: string, status: string, property_id: any, people?: string | null, from_date: string, done_on: any, BID: any, property: { __typename?: 'properties', PID: any, amenities?: any | null, bath: string, beds: string, cost: string, description: string, host_id: any, image?: string | null, listed_on: any, name: string, per: string, type: string, hosts: { __typename?: 'hosts', name: string, HID: any } } }> };
...
export const useRemoveBookingsWherebooking_IdMutation = <
      TError = unknown,
      TContext = unknown
    >(options?: UseMutationOptions<RemoveBookingsWherebooking_IdMutation, TError, RemoveBookingsWherebooking_IdMutationVariables, TContext>) =>
    useMutation<RemoveBookingsWherebooking_IdMutation, TError, RemoveBookingsWherebooking_IdMutationVariables, TContext>(
      ['removeBookingsWherebooking_id'],
      (variables?: RemoveBookingsWherebooking_IdMutationVariables) => fetcher<RemoveBookingsWherebooking_IdMutation, RemoveBookingsWherebooking_IdMutationVariables>(RemoveBookingsWherebooking_IdDocument, variables)(),
      options
    );
useRemoveBookingsWherebooking_IdMutation.getKey = () => ['removeBookingsWherebooking_id'];
...
export const useGetBookingsWhereUser_IdQuery = <
    ...
    useQuery<GetBookingsWhereUser_IdQuery, TError, TData>(
      variables === undefined ? ['getBookingsWhereUser_id'] : ['getBookingsWhereUser_id', variables],
      fetcher<GetBookingsWhereUser_IdQuery, GetBookingsWhereUser_IdQueryVariables>(GetBookingsWhereUser_IdDocument, variables),
      options
    );

useGetBookingsWhereUser_IdQuery.getKey = (variables?: GetBookingsWhereUser_IdQueryVariables) => variables === undefined ? ['getBookingsWhereUser_id'] : ['getBookingsWhereUser_id', variables];
;
